...
export const CATEGORIES_TREE: CategoryNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Измерительное оборудование, инструмент и комплектующие' },
      { name: 'Оборудование и инструменты для ремонта и обслуживания транспорта' },
      { name: 'Продукция химического и нефтяного машиностроения' },
